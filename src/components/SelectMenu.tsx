...
import '@/styles/components/Editable.module.css';
import { SelectSlashMenu } from '@/styles/components/Editor';
...
class SelectMenu extends React.Component {
  ...
  render() {
    ...
    return (
      <SelectSlashMenu className="SelectMenu" style={positionAttributes}>
        <div className="Items">
